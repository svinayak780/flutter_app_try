...
//                        SizedBox(height: 9),
                      Text(" ${ ( _homePrice > 0 && _interest > 0.0) ? "\$${calculateMonthlyPayment(_homePrice, _interest, _lengthOfLoan)}" : "0"}",style: TextStyle(color: Color(0xff0077c2), fontSize: 45),)
                    ],
                 ),
               ),
            ),
...
//                        style: TextStyle(color: Colors.black),//TODO: theme this! // Done
                        decoration: InputDecoration(
                           prefixText: "Home Price: ",
                           prefixIcon: Icon(Icons.home, color: Color(0xff0077c2),)
                        ),
                     ...
                     Column(
                        children: <Widget>[
                          Slider(
                              min: 0.0,
                              max: 10.0,
//                              activeColor: Colors.red , //TODO: Theme this! //Done
//                              inactiveColor: Colors.grey, //TODO: Theme this! //Done
                             // divisions: 10,
                              value: _interest,
